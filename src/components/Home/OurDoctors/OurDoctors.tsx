          ...
          <AlertDialogContent className={`rounded-lg lg:h-2/3 h-[500px] lg:max-w-4xl max-w-sm overflow-x-scroll`}>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleConfirmAction} 
                          className="flex whitespace-nowrap w-full items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-blue-500 hover:bg-blue-600 text-white shadow-md transition-all duration-200 border border-blue-600"
